...
class Plot {
    ...
    public function showAsBars($series) {
	...
	public function setBarWidth($series, $width) {
		$this->Data[$series]['bars']['barWidth'] = $width;
	}
	public function setBarLineWidth($series, $width) {
		$this->Data[$series]['bars']['lineWidth'] = $width;
	}
	 ...
	 * @return int
	 */
	public function addYAxis($i, $position, $align = true, $alignTo = 1, $show=true) {
        $this->Options['yaxes'][$i-1]['position'] = $position;
        $this->Options['yaxes'][$i-1]['show'] = $show;
