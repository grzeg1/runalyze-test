...
class TrainingPlotPacePulse extends TrainingPlot {
	...
	protected function initData() {
        ...
        $this->DataTime = TrainingPlotPulse::getData($this->Training);

		$this->Plot->Data[] = array('label' => 'Pace', 'color' => 'rgb(0,0,136)', 'data' => $this->DataPace);
        $this->Plot->Data[] = array('label' => 'Heart rate', 'color' => 'rgb(136,0,0)', 'data' => $this->DataPulse, 'yaxis' => 2);
        $this->Plot->Data[] = array('label' => 'Time', 'color' => 'rgba(0,0,0,0)', 'data' => $this->DataTime);
	}
